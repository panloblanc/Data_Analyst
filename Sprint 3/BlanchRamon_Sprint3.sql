# PART 1: Modificar taules

-- show columns from company;
-- show tables;
-- show create table company;

-- rename table company to company2;
-- alter table company add nuevoCampo int not null;
-- alter table company change oldNameCol newNameCol smallint not null;
-- alter table company drop column deleteCol;
...
CREATE TABLE `credit_card` (
  ...
  `expiring_date` char(8) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
;
...
SELECT transaction.id ID_Transaction, useer.surname, credit_card.iban, company_name FROM transaction
